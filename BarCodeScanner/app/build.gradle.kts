...
dependencies {
    ...
    //Google’s Accompanist libraries for requesting permissions in Jetpack Compose
    // allows us to have a permission state which is remembered with only one line
